...
<template>
  <div id="termgif-region" class="scene-region active">
    <div id="termgif-frame" class="termgif-frame reveal" :class="{ shown: store.isRevealed('termgif-frame') }">
      <div class="termgif-titlebar">
